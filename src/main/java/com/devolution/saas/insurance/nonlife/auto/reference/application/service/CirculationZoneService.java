 ...
 */
public interface CirculationZoneService extends TenantAwareCrudService<CirculationZoneDTO, CirculationZone> {
    ...
    /**
     * Active ou désactive une zone de circulation.
     *
     * @param id             L'ID de la zone de circulation
     ...
     * @return La zone de circulation mise à jour, ou empty si non trouvée
     */
    Optional<CirculationZoneDTO> setActive(UUID id, boolean active, UUID organizationId);
}
