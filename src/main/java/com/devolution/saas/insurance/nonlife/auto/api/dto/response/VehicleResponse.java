...
public record VehicleResponse(
    ...
    /**
     * Classe Builder pour VehicleResponse.
     */
    public static class Builder {
        ...
        public VehicleResponse build() {
            return new VehicleResponse(
                    id, registrationNumber, manufacturerId, manufacturerName, modelId, modelName, modelVariant,
                    ...
                    purchaseDate, purchaseValue, currentValue, mileage, vin, colorId, colorName,
                    ownerId, ownerName, organizationId, autoPolicyId, hasAntiTheftDevice, parkingType
            );
        }
    }
}
